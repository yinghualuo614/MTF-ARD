...
class OSNet(nn.Module):
    ...
    def extract_feature(self, x, preReLU=False):
        ...
        feat1 = self.conv2(x)
        feat2 = self.conv3(feat1)
        feat3 = self.conv4(feat2)
...
def init_pretrained_weights(model, key=""):
    ...
    cached_file = "/data/workspace_zhangh/code/GitHub/RobustReidResearch-main/pytorch_reid_models/reid_models/modeling/third_party_models/FastReID/osnet_x1_0_imagenet.pth"
